...
cupcake1 = RegularCupcake("Stars and Stripes", 2.99, "Vanilla", "Vanilla", "Chocolate")
...
#functions to add cupcake classes 
...
# functions that add the cupcake dictionaries to csv
